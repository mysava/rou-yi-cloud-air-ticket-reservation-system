...
<!--      <el-table-column label="编号" align="center" prop="flightid" />-->
      ...
      <el-table-column label="剩余商务舱数量" align="center" prop="vipNumChange" />
      <el-table-column label="商务舱价格" align="center" prop="vipPrice" />
      <el-table-column label="剩余普通舱数量" align="center" prop="comNumChange" />
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="航班编号" prop="fno">
          ...
          <el-form-item label="飞机舱" prop="level">
            <el-select v-model="form.level" placeholder="请选择飞机舱"  @change="selection" clearable :style="{width: '100%'}">
