<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="票价" prop="originalprice">
        <el-input
      ...
      <el-form-item label="客容量" prop="passengercapacity">
        <el-input
          v-model="queryParams.passengercapacity"
          placeholder="请输入客容量"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="flightList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="飞机编号" align="center" prop="aircraftid" />
      ...
      <el-table-column label="票价" align="center" prop="originalprice" />
      <el-table-column label="客容量" align="center" prop="passengercapacity" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="飞机编号" prop="aircraftid">
          <el-input v-model="form.aircraftid" placeholder="请输入飞机编号" />
        </el-form-item>
        <el-form-item label="出发地" prop="departure">
        ...
        <el-form-item label="票价" prop="originalprice">
          <el-input v-model="form.originalprice" placeholder="请输入票价" />
        </el-form-item>
        <el-form-item label="客容量" prop="passengercapacity">
          <el-input v-model="form.passengercapacity" placeholder="请输入客容量" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除【请填写功能名称】编号为"' + flightids + '"的数据项？').then(function() {
