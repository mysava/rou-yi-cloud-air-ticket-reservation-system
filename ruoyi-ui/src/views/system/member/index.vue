<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="购买记录" prop="order">
        <el-input
    ...
    <el-table v-loading="loading" :data="memberList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="购买记录" align="center" prop="order" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="用户编号" prop="uid">
          <el-input v-model="form.uid" placeholder="请输入用户编号" />
        </el-form-item>
        <el-form-item label="用户名称" prop="username">
        ...
        <el-form-item label="购买记录" prop="order">
          <el-input v-model="form.order" placeholder="请输入购买记录" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getMember(idcard).then(response => {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除【请填写功能名称】编号为"' + idcards + '"的数据项？').then(function() {
        return delMember(idcards);
      }).then(() => {
        this.getList();
