<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="seatList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="乘客姓名" align="center" prop="name" />
      <el-table-column label="乘客身份证" align="center" prop="idcard" />
      <el-table-column label="乘客电话" align="center" prop="phone" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="乘客身份证" prop="idcard">
          <el-input v-model="form.idcard" placeholder="请输入乘客身份证" />
        </el-form-item>
        <el-form-item label="乘客电话" prop="phone">
          <el-input v-model="form.phone" placeholder="请输入乘客电话" />
        </el-form-item>
      </el-form>
...
<script>
import { listSeat, getSeat, delSeat, addSeat, updateSeat } from "@/api/system/seat";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除【请填写功能名称】编号为"' + seatids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/seat/export', {
        ...this.queryParams
